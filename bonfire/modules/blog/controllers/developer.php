...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Blog.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Blog.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_blog())
			{
				...
				Template::redirect(SITE_AREA .'/developer/blog');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Blog.Developer.Edit');
		...
		{
			$this->auth->restrict('Blog.Developer.Delete');
