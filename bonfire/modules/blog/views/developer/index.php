<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Blog.Developer.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('Blog.Developer.Delete')) : ?>
				<tr>
					<td colspan="7">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Blog.Developer.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/developer/blog/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->blog_title) ?></td>
				<?php else: ?>
