...
<div id="sharing_bar">
    ...
    if ( isset ($settings['news.share_stumbleupon']) && $settings['news.share_stumbleupon'] == 1) : ?>
        <span class='st_linkedin_hcount' displayText='<?php echo lang('nw_share_stumbleupon'); ?>'></span>
        <?php
    endif;
    // Delicious
    if ( isset ($settings['news.share_delicious']) && $settings['news.share_delicious'] == 1) : ?>
        <span class='st_pinterest_hcount' displayText='<?php echo lang('nw_share_delicious'); ?>'></span>
        <?php
    endif;
    // Email
