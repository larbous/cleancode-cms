...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Anti_Bot.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Anti_Bot.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_anti_bot())
			{
				...
				Template::redirect(SITE_AREA .'/developer/anti_bot');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/anti_bot');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Anti_Bot.Developer.Edit');
		...
		{
			$this->auth->restrict('Anti_Bot.Developer.Delete');
