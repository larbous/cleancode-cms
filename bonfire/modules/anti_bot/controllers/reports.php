...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Anti_Bot.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Anti_Bot.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_anti_bot())
			{
				...
				Template::redirect(SITE_AREA .'/reports/anti_bot');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/anti_bot');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Anti_Bot.Reports.Edit');
		...
		{
			$this->auth->restrict('Anti_Bot.Reports.Delete');
