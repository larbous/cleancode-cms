...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/reports/teamspeakviever', lang('teamspeakviever_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('TeamspeakViever.Reports.Delete')) : ?>
