...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('TeamspeakViever.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('TeamspeakViever.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_teamspeakviever())
			{
				...
				Template::redirect(SITE_AREA .'/reports/teamspeakviever');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/teamspeakviever');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('TeamspeakViever.Reports.Edit');
		...
		{
			$this->auth->restrict('TeamspeakViever.Reports.Delete');
