...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('TeamspeakViever.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('TeamspeakViever.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_teamspeakviever())
			{
				...
				Template::redirect(SITE_AREA .'/settings/teamspeakviever');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/teamspeakviever');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('TeamspeakViever.Settings.Edit');
		...
		{
			$this->auth->restrict('TeamspeakViever.Settings.Delete');
