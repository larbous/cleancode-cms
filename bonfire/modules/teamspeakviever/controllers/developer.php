...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('TeamspeakViever.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('TeamspeakViever.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_teamspeakviever())
			{
				...
				Template::redirect(SITE_AREA .'/developer/teamspeakviever');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/teamspeakviever');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('TeamspeakViever.Developer.Edit');
		...
		{
			$this->auth->restrict('TeamspeakViever.Developer.Delete');
